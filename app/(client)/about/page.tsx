    ...
    <>
      ...
      <main className='max-w-[1200px] mx-auto pt-12'>
        <div className='w-full mb-[60px]'>
          <h2 className='text-[28px] font-bold mb-3'>인사말</h2>
          <hr className='border-t border-gray-400 mb-[40px]' />
          <h1 className='text-[32px] font-bold text-gray-800 mb-[40px] text-center'>
            체대입시, 합격을 FLEX하라!
          </h1>
          <div className='whitespace-pre-line leading-[1.8] text-[18px] text-gray-600 text-center'>
            {`안녕하세요. 플렉스체대입시입니다.
...
플렉스는 21세기 글로벌시대에 맞는 경쟁력을 갖춘 인재를 키우기 위해 항상 노력합니다.`}
        ...
        <div className='flex justify-center w-full h-auto mb-[60px]'>
          <Image
